...
async function ensureCrmAdministratorDefaultPermissions(): Promise<void> {
  const codes = [
    'FULL_ACCESS', 'MANAGE_SYSTEM', 'VIEW_LOGS', 'VIEW_ROLE_GROUPS', 'MANAGE_ROLE_GROUPS',
    'VIEW_SETTINGS', 'EDIT_SETTINGS', 'VIEW_EMPLOYEE_ACCOUNTS', 'STAFF_LOGOUT', 'STAFF_LOCK',
    'STAFF_TEMP_PASSWORD', 'STAFF_INSPECT', 'VIEW_DASHBOARD', 'VIEW_REPORTS', 'VIEW_PERFORMANCE',
    'VIEW_HR', 'CREATE_HR', 'UPDATE_HR', 'DELETE_HR', 'MANAGE_HR', 'VIEW_EMPLOYEE_TYPE_CATALOG',
    'MANAGE_EMPLOYEE_TYPE_CATALOG', 'VIEW_CONTRACTS', 'MANAGE_CONTRACTS', 'VIEW_LEAVE_REQUESTS',
    'CREATE_LEAVE_REQUEST', 'APPROVE_LEAVE_REQUESTS', 'DELETE_LEAVE_REQUESTS', 'VIEW_FLOATING_POOL',
    'MANAGE_DATA_POOL', 'DATA_POOL_CONFIG', 'CONFIG_DISTRIBUTION', 'CLAIM_LEAD', 'ASSIGN_LEAD',
    'RECALL_LEAD', 'VIEW_CSKH_POOL', 'DISTRIBUTE_FLOATING_POOL', 'DISTRIBUTE_FLOATING_CROSS_ORG',
    'VIEW_CUSTOMERS', 'VIEW_ALL_COMPANY_CUSTOMERS', 'CREATE_CUSTOMER', 'UPDATE_CUSTOMER',
    'DELETE_CUSTOMER', 'MANAGE_CUSTOMERS', 'VIEW_MARKETING_CAMPAIGNS', 'CREATE_MARKETING_CAMPAIGN',
    'UPDATE_MARKETING_CAMPAIGN', 'DELETE_MARKETING_CAMPAIGN', 'VIEW_MARKETING_PLATFORMS',
    'MANAGE_MARKETING_PLATFORMS', 'VIEW_SALES', 'UPDATE_SALES_LEAD', 'MANAGE_SALES',
    'VIEW_SALES_EFFECTIVENESS', 'VIEW_RESALES', 'UPDATE_RESALES_LEAD', 'MANAGE_RESALES',
    'VIEW_CSKH_EFFECTIVENESS', 'VIEW_PRODUCTS', 'CREATE_PRODUCT', 'UPDATE_PRODUCT',
    'DELETE_PRODUCT', 'MANAGE_PRODUCTS', 'VIEW_SUPPORT_TICKETS', 'UPDATE_SUPPORT_TICKETS',
    'DELETE_SUPPORT_TICKETS', 'CREATE_SUPPORT_TICKET', 'VIEW_SUPPORT_WIZARD', 'VIEW_ORDERS',
    'VIEW_ALL_COMPANY_ORDERS', 'CREATE_ORDER', 'EDIT_ORDER', 'CONFIRM_ORDER', 'PUSH_ORDER_TO_SHIPPING',
    'CANCEL_ORDER', 'DELETE_ORDER', 'MANAGE_ORDERS', 'MANAGE_SHIPPING', 'ASSIGN_SHIPPING_DAILY_QUOTA',
    'VIEW_INVENTORY', 'MANAGE_INVENTORY_IN', 'MANAGE_INVENTORY_OUT', 'MANAGE_WAREHOUSE',
    'VIEW_ACCOUNTING', 'CREATE_ACCOUNTING', 'UPDATE_ACCOUNTING', 'MANAGE_ACCOUNTING',
    'VIEW_PAYROLLS', 'APPROVE_PAYROLLS', 'CONFIG_OPERATIONS', 'CONFIG_ORG_STRUCTURE',
    'CONFIG_DATA_FLOW', 'VIEW_DIVISIONS', 'MANAGE_NOTIFICATIONS', 'SEND_STAFF_NOTIFICATION',
    'CREATE_DRAFT_NOTIFICATION', 'VIEW_DOCUMENTS', 'UPLOAD_DOCUMENT', 'DELETE_DOCUMENT',
    'MANAGE_INTERNAL_NOTES', 'DELETE_CONVERSATION', 'VIEW_CHATS', 'VIEW_TUTORIALS'
  ];
