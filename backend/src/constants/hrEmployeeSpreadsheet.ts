/**
 * Thứ tự và nhãn cột Excel: import mẫu, import thực tế, export — phải giống nhau.
 * Không gồm khối / phòng ban / quản lý trực tiếp (chỉ dùng danh mục Bộ phận HR).
 * Đồng bộ với `frontend/src/constants/hrEmployeeSpreadsheet.ts`.
 */
export const HR_EMPLOYEE_SHEET_COLUMNS: { header: string; key: string; width: number }[] = [
